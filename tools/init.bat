...
call "./../git/bin/git.exe" remote add origin https://github.com/taislin/civ13-od-client
...
call "./../tools/git/bin/git.exe" remote add origin https://github.com/taislin/civ13-od-client
